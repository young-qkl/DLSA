...
class PurelyVisualConvolutionalBranch(nn.Module):
    ...
    def forward(self, x, lang_feat=None, stage_id=0):
        bs, n, dim = x.shape
...
# Preserve the historical class name used by the backbone source.
VariousReceptive = PurelyVisualConvolutionalBranch
